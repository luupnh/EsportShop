            ...
            if(formKey.currentState.validate())
              {
                ...
                .document(DateTime.now().millisecondsSinceEpoch.toString())
                    .setData(model)
                .then((value){
                  final snack = SnackBar(content: Text("New Address add successfully"),);
            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: Text("New Address",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize:20.0),),
