                ...
                child: Column(
                  children: [
                    ...
                    FutureBuilder<DocumentSnapshot>(
                      ...
                      {
                        return snap.hasData
                            ? AdminShippingDetails(model: AddressModel.fromJson(snap.data.data),orderBy: orderBy,)
                            : Center(child: circularProgress(),);
                      },
                    )
                  ],
...
class AdminStatusBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String msg;
    IconData iconData;
    status ? iconData = Icons.done : iconData = Icons.lock_clock;
...
class AdminShippingDetails extends StatelessWidget {
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: (){
                confirmParcelShifted(context,getOrderId,orderBy,{EcommerceApp.isSuccess:true});
              },
              child: Container(
                decoration: new BoxDecoration(
                    gradient: new LinearGradient(
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: (){
                delete(context,getOrderId,orderBy);
              },
              child: Container(
                decoration: new BoxDecoration(
                    gradient: new LinearGradient(
  ...
  confirmParcelShifted(BuildContext context,String mOrderId,String orderBy,Map<String, dynamic>data)
  {
    EcommerceApp.firestore
        .collection(EcommerceApp.collectionOrders)
        .document(mOrderId)
