...
import 'package:EsportShop/Store/cartdefault.dart';
...
class StoreHomeDefault extends StatefulWidget {
  @override
  _StoreHomeDefaultState createState() => _StoreHomeDefaultState();
}

class _StoreHomeDefaultState extends State<StoreHomeDefault> {
  @override
            ...
            Stack(
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    Route route =
                        MaterialPageRoute(builder: (c) => CartPageDefault());
